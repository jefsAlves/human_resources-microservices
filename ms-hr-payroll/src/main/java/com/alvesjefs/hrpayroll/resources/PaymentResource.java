...
//	@GetMapping(value = "/find/days/{days}")
//	public ResponseEntity<Payment> findCpf(@RequestParam String cpf, @PathVariable Integer days) {
//		Payment payment = paymentService.getPayment(cpf, days);
//		return ResponseEntity.ok().body(payment);
//	}
}
